...
public static class GrindSpotDatabase
{
    public static readonly List<GrindSpot> AllSpots = new()
    {
        ...
        // ==========================================
        // --- Land of the Morning Light (Hwanghae & Donghae) ---
        // ==========================================
        ...
        new GrindSpot { Name = "Mount Ahshi", Region = "Morning Light", TrashPrice = 25_000, RecommendedApDp = "290 AP / 370 DP" },
        new GrindSpot { Name = "Beombawi Rock", Region = "Morning Light", TrashPrice = 25_000, RecommendedApDp = "300 AP / 380 DP" },
        ...
        new GrindSpot { Name = "Elvia Fogans (Swamp)", Region = "Serendia Elvia", TrashPrice = 16_000, RecommendedApDp = "260 AP / 310 DP" },
        new GrindSpot { Name = "Elvia Nagas (Swamp)", Region = "Serendia Elvia", TrashPrice = 16_000, RecommendedApDp = "260 AP / 310 DP" },
        ...
        new GrindSpot { Name = "Polly's Forest (Mushrooms)", Region = "Kamasylvia", TrashPrice = 9_720, RecommendedApDp = "160 AP / 200 DP" },
        new GrindSpot { Name = "Manshaum Forest", Region = "Kamasylvia", TrashPrice = 8_800, RecommendedApDp = "240 AP / 280 DP" },
        new GrindSpot { Name = "Navarn Steppe (Feather Wolves / Birds)", Region = "Kamasylvia", TrashPrice = 8_800, RecommendedApDp = "210 AP / 250 DP" },
        new GrindSpot { Name = "Forest Ronaros (Tooth Fairy)", Region = "Kamasylvia", TrashPrice = 8_500, RecommendedApDp = "240 AP / 280 DP" },
        ...
        new GrindSpot { Name = "Blood Wolf Settlement (Kagtums)", Region = "Drieghan", TrashPrice = 3_800, RecommendedApDp = "190 AP / 210 DP" },
        new GrindSpot { Name = "Tshira Ruins (Swamp)", Region = "Drieghan", TrashPrice = 3_500, RecommendedApDp = "140 AP / 180 DP" },

        // ==========================================
        // --- Ocean & Island Monster Zones ---
        // ==========================================
        new GrindSpot { Name = "Sycraia Underwater (Abyssal)", Region = "Ocean", TrashPrice = 18_000, RecommendedApDp = "270 AP / 330 DP" },
        new GrindSpot { Name = "Padix Island (Pirates)", Region = "Ocean", TrashPrice = 13_200, RecommendedApDp = "270 AP / 320 DP" },
        ...
        new GrindSpot { Name = "Pirate Island (Kuit)", Region = "Ocean", TrashPrice = 4_200, RecommendedApDp = "100 AP / 140 DP" },
        ...
        new GrindSpot { Name = "Soldier's Grave", Region = "Mediah", TrashPrice = 3_800, RecommendedApDp = "100 AP / 150 DP" },
        ...
        new GrindSpot { Name = "Shadow Knights (Calpheon)", Region = "Calpheon", TrashPrice = 1_800, RecommendedApDp = "50 AP / 90 DP" },
        new GrindSpot { Name = "Treant / Mansha Forest", Region = "Calpheon", TrashPrice = 1_500, RecommendedApDp = "50 AP / 90 DP" },
        new GrindSpot { Name = "Rhutum Tribe", Region = "Calpheon", TrashPrice = 1_400, RecommendedApDp = "50 AP / 90 DP" },
        new GrindSpot { Name = "Saunil Battlefield", Region = "Calpheon", TrashPrice = 1_400, RecommendedApDp = "45 AP / 80 DP" },
        new GrindSpot { Name = "Catfishman Camp (Lake Kaia)", Region = "Calpheon", TrashPrice = 1_300, RecommendedApDp = "45 AP / 80 DP" },
        new GrindSpot { Name = "Cron Castle (Balenos)", Region = "Balenos", TrashPrice = 1_100, RecommendedApDp = "30 AP / 50 DP" },
